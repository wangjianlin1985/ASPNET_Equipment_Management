...
using System.Data;
public partial class DeviceLend_frontList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request["lendDate"] != null && Request["lendDate"].ToString() != "")
            {
                sqlstr += "  and Convert(varchar,lendDate,120) like '" + Request["lendDate"].ToString() + "%'";
                lendDate.Text = Request["lendDate"].ToString();
            }
    ...
    private void BindData(string strClass)
    {
        ...
        DataTable dsLog = BLL.bllDeviceLend.GetDeviceLend(NowPage, PageSize, out AllPage, out DataCount, HWhere.Value);
        ...
        RpDeviceLend.DataSource = dsLog;
        RpDeviceLend.DataBind();
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?deviceObj=" + deviceObj.SelectedValue.Trim()+ "&&lendDate=" + lendDate.Text.Trim() + "&&userObj=" + userObj.SelectedValue.Trim());
        }
