...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">设备管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>DeviceType/frontlist.aspx">设备类别</a></li>
                <li><a href="<%=basePath %>DeviceInfo/frontlist.aspx">设备查询</a></li>
                <li><a href="<%=basePath %>DeviceLend/frontlist.aspx">设备借用</a></li>
                <li><a href="<%=basePath %>DeviceRepair/frontlist.aspx">设备维修</a></li>
                <li><a href="<%=basePath %>Rubbish/frontlist.aspx">报废设备</a></li>
                <li><a href="<%=basePath %>Accident/frontlist.aspx">设备事故</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Accident/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;设备事故上报</a></li>
                        <li><a href="<%=basePath %>Accident/frontUserList.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我上报的设备事故</a></li>
                        <li><a href="<%=basePath %>DeviceLend/frontUserList.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的设备借用</a></li>
